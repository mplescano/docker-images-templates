...
echo "About to su to mqm"
su -l mqm -c "setmqaut -m $1 -t qmgr -g mqclient +connect +inq +dsp"
...
#@see http://www-01.ibm.com/support/docview.wss?uid=swg21250706
su -l mqm -c "setmqaut -m $1 -n SYSTEM.DEFAULT.MODEL.QUEUE -t q -g mqclient +inq +browse +get"
su -l mqm -c "setmqaut -m $1 -n SYSTEM.ADMIN.COMMAND.QUEUE -t q -g mqclient +inq +put"
su -l mqm -c "setmqaut -m $1 -n SYSTEM.MQEXPLORER.REPLY.MODEL -t q -g mqclient +inq +browse +get +dsp"
#@see https://www.ibm.com/support/knowledgecenter/en/SSMKHH_9.0.0/com.ibm.etools.mft.doc/an07080_.htm
#@see http://permalink.gmane.org/gmane.network.mq.devel/16661
su -l mqm -c "setmqaut -m $1 -n 'SYSTEM.BROKER.DEPLOY.QUEUE' -t queue -g mqclient -all +put"
su -l mqm -c "setmqaut -m $1 -n 'SYSTEM.BROKER.DEPLOY.REPLY' -t queue -g mqclient -all +put +get"

echo "Configuring admin user"
configure_os_user 3001 1000 MQ_ADMIN_NAME MQ_ADMIN_PASSWORD /home/admin
